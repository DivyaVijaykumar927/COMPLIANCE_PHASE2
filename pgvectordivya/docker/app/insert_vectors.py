...
# Read the CSV file
df = pd.read_csv("C:\pgvectorscale-rag-solution_new_divya\pgvectorscale-rag-solution\data\processed_file.csv", sep=",")  # Assuming the cleaned file uses commas as separators
df.head()
